...
MIGRATION_MODULES = {"sites": "dorm_launch_django.contrib.sites.migrations"}
...
LOGIN_REDIRECT_URL = "shuttles:list"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "dorm_launch_django.utils.context_processors.settings_context",
            ],
        },
    }
]
